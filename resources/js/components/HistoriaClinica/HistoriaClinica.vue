      ...
      <div class="card mt-2">
        <template v-if="listado == 0">
          <div class="card-header">
            <h4>Unidad de Cuidados Intesivo</h4>
          </div>
          <div class="card-body">
            ...
            <div class="table-responsive-sm">
              <table class="table table-bordered table-sm">
                <thead>
                  <tr>
                    <th class="text-center" width="95">Opciones</th>
                  ...
                  <tr v-for="(item, index) in arrayLista" :key="index">
                    <td class="text-center">
                      <button
                        type="button"
                        class="btn btn-primary btn-sm"
                        @click="mostrarFormulario(item.id,
                                                  item.aplicaNeonatal,
                                                  item.idGenero)"
                      >
        ...
        <template v-if="listado==2">
          <componentFacturaConsolidado :idIngreso="idIngreso"></componentFacturaConsolidado>
        </template>
      </div>
      <!-- Datos del Ingreso -->
      <template v-if="listado == 1">
        <template v-if="seleccion == mIngreso">
          ...
          <ingresomedico-component v-else :idGenero="idGenero" :idIngreso="idIngreso"></ingresomedico-component>
        </template>
...
import componentFacturaConsolidado from "../Facturacion/FacturaConsolidado.vue";

export default {
  components: {
    componentEpicrisis,
    componentFacturaConsolidado,
    enfermeria,
  },
  data() {
    return {
