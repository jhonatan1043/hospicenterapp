                    ...
                    <div class="form-row">
                      ...
                      <div class="col-xl-9">
                        <textarea
                          ...
                          style="resize: none;"
                          :disabled="editable == 0"
                           v-bind:style="nota == '' && editable == 1 ?'background-color: #FEF9E7':''"
                          v-model="nota"
                        ></textarea>
                      </div>
                    </div>
                              ...
                              <tr  v-for="(item, index) in arrayInsumos" :key="index">
                                ...
                                <td>
                                  <input
                                    ...
                                    width="10"
                                    :disabled="!editable"
                                     v-bind:style="item.cantidad == 0 && editable == 1 ?'background-color: #FEF9E7':''"
                                  />
                                </td>
                              </tr>
                            </tbody>
...
<script src="../../Scripts/HistoriaClinica/Enfermeria.js" ></script>
