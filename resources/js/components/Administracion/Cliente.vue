          ...
          <template v-if="listado==1">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-sm">
                ...
                <tbody>
                  <tr v-for="(item, index) in arrayCliente" :key="index">
                    <td class="text-center">
                      <button
                        type="button"
                        class="btn btn-warning btn-sm"
                        @click="editarRegistro(item.id,item.idTercero,item.cliente)"
                      >
                      ...
                      <button
                        ...
                        @click="anularCliente(item.id)"
                      >
                        <i class="icon-trash"></i>
                      </button>
                    </td>
                    <td class="text-center" v-text="item.cliente"></td>
              ...
              <form>
                <div class="form-row">
                  <div class="col-md-6 mb-2">
                    <div class="input-group">
                      ...
                      <button type="button" :disabled="accion ==1" class="btn btn-primary btn-sm" @click="abrirModal()">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-xs-12 col-lg-3 col-sm-6 col-md-3 col-xl-3">
                    ...
                    >
                      <option select :value="0" disabled>Seleccionar</option>
                      <option select :value="1">Credito</option>
                      <option select :value="2">Contado</option>
                    </select>
                  </div>
                  <div class="form-group col-xs-12 col-lg-3 col-sm-6 col-md-3 col-xl-3">
                    ...
                    >
                      <option select :value="0" disabled>Seleccionar</option>
                      <option select :value="1">Contribuyente</option>
                      <option select :value="2">Simplificado</option>
                      <option select :value="3">Comun</option>
                    </select>
                  </div>
                </div>
...
<script src="../../Scripts/Administracion/Cliente.js"></script>